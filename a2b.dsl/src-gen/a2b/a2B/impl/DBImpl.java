 ...
 *   <li>{@link a2b.a2B.impl.DBImpl#getCrcValue <em>Crc Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DBImpl extends InstructionImpl implements DB
{
  ...
  public void setCrcValue(String newCrcValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, A2BPackage.DB__CRC_VALUE, oldCrcValue, crcValue));
  }
